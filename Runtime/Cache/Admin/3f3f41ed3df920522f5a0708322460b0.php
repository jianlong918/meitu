            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form role="form" class="ajaxform form-horizontal" action="<?php echo U('admin/shopproduct/usave');?>"  method="post">
                                    <div class="form-group ">
                                        <label  class="col-sm-2 control-label"><span style="color:#F77DA6;">*</span>产品名称</label>
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text"   name="name" value="<?php echo ($product["name"]); ?>" style="max-width:300px;">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10" style="line-height: 33px; height: 33px;">
                                            ...
                                            <input class="radio i-checks" type="radio" name="is_recommend" <?php if($product["is_recommend"] == 1): ?>checked<?php endif; ?> value="1"> 是

                                            <input class="radio i-checks" type="radio" name="is_recommend" <?php if($product["is_recommend"] == 0): ?>checked<?php endif; ?> value="0" > 否
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="col-sm-2 control-label">所需积分</label>
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text"   name="price" value="<?php echo ($product["price"]); ?>" style="max-width:300px;">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="col-sm-2 control-label">市场价格</label>
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text"   name="market_price" value="<?php echo ($product["market_price"]); ?>" style="max-width:300px;">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="col-sm-2 control-label">限住人数</label>
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text"   name="max_num" value="<?php echo ($product["max_num"]); ?>" style="max-width:300px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text"   name="order_num" value="<?php echo ($product["order_num"]); ?>" style="max-width:300px;">
                                        </div>
                                    </div>
                                    ...
                                    <?php if(!empty($product["img_arr"])): ?><div class="form-group ">
                                        <label  class="col-sm-2 control-label">产品已上传图片</label>
                                        <div class="col-sm-10">
                                            <?php if(is_array($product["img_arr"])): foreach($product["img_arr"] as $k=>$vo): ?><div class="tj" id="li_<?php echo ($k); ?>">
                                                    <img src="<?php echo ($vo); ?>" width="102px" height="102px">
                                                    <input type="hidden" id="li_path_<?php echo ($k); ?>" name="img[]" value="<?php echo ($vo); ?>">
                                                    <button type="button" style="margin-left: 35px;margin-top:5px;" onclick="del_li(<?php echo ($product["id"]); ?>,<?php echo ($k); ?>)">删除</button>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="province_id" id="province_id" style="max-width:150px;float:left;">
                                                <option value="0">请选择</option>
                                                <?php if(is_array($districts)): $i = 0; $__LIST__ = $districts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $product['province_id']): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                            <select class="form-control" id="city_id"  name="city_id"  style="max-width:150px;float:left;margin-left: 10px;">
                                                <option value="0">请选择</option>
                                                <?php if(is_array($cities)): $i = 0; $__LIST__ = $cities;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($product["city_id"] == $vo['id']): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                            <select class="form-control" id="area_id"  name="area_id"  style="max-width:150px;float:left;margin-left: 10px;">
                                                <option value="0">请选择</option>
                                                <?php if(is_array($areas)): $i = 0; $__LIST__ = $areas;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($product["area_id"] == $vo['id']): ?>selected<?php endif; ?> ><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text"   name="address" value="<?php echo ($product["address"]); ?>"  style="max-width:300px;">
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="col-sm-2 control-label">更新时间</label>
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})"  name="updated_at" value="<?php echo ($product["updated_at"]); ?>"  style="max-width:300px;">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="description" style="max-width:600px;height: 150px;" ><?php echo ($product["description"]); ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label  class="col-sm-2 control-label">基地详情</label>
                                        <div class="col-sm-10">
                                            <script type="text/plain" id="editor" name="content" style="width:95%;height:300px;"><?php echo ($product["content"]); ?></script>
                                        </div>
                                    </div>
