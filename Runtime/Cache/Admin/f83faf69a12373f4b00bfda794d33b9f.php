            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-lg-12">
                                <form role="form" class="ajaxform form-horizontal" action="<?php echo U('admin/newstype/save');?>"  method="post">
                                    <div class="form-group ">
                                        <label  class="col-sm-2 control-label"><span style="color:#F77DA6;">*</span>栏目名称</label>
                                        <div class="col-sm-10">
                                            <input class="form-control"  type="text"   name="typename" style="max-width:300px;">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control" name="pid" style="max-width:300px;" >
                                                <?php if($id == 0): ?><option value="0">顶级菜单</option>
                                                    <?php else: ?>
                                                    <option value="<?php echo ($id); ?>"><?php echo ($typename); ?></option><?php endif; ?>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-sm-10">
                                            <script type="text/plain" id="editor" name="content" style="width:90%;height:300px;"></script>
                                        </div>
                                    </div>
