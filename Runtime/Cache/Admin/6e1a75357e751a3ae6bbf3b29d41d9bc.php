            ...
            <div class="col-sm-6" style='width: 100%'>
                <div class="ibox">
                    <div class="ibox-title">
                        <h5>栏目管理</h5>
                        <?php if($auth->check( 'admin/newstype/add', session('uid') )){ ?>
                        <a href="<?php echo U('admin/newstype/add/pid/0');?>" class="btn btn-info btn-xs" style='margin-left: 20px'>添加顶级栏目</a>
                        <?php } ?>
                    </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>栏目名称</th>
                                    <th>排序</th>
                                    <?php if($auth->check( 'admin/newstype/update', session('uid') )||$auth->check( 'admin/newstype/del', session('uid') )||$auth->check( 'admin/newstype/add', session('uid') )){ ?>
                                    <th>操作</th>
                                    <?php } ?>
                                </tr>
                            </thead>
